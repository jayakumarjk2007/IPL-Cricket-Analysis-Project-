...
generate_data.py          script that produced data/ (see note below)
README.md                 this file
```
...
To regenerate the sample data (or after tweaking `generate_data.py`):
